...
bool http_client::post(const std::string& url, const std::string& body, std::string& data, const std::list<std::string>& headers_list)
{
    string reply;
    struct curl_slist* headers = NULL;
	list<string>::const_iterator it;
	for (it = headers_list.cbegin(); it != headers_list.cend(); ++it) {
